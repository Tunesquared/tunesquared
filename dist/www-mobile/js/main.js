...
define('models/Song',['$', 'backbone'], function ($, Backbone) {
...
define('models/Playlist',['$', 'underscore', 'backbone', 'models/Song'], function($, _, Backbone, Song) {
...
// Includes file dependencies
define('models/Session',['$', 'underscore', '../models/Party', 'backbone', 'backbone'], function ($, _, PartyModel, Backbone) {
...
*/
define('views/HomeView',['backbone', 'underscore', '$', 'models/Session'], function(Backbone, _, $, Session) {
...
define('views/SongView',['backbone', 'underscore', '$'], function(Backbone, _, $) {
...
define('views/SearchSongView',['backbone', 'underscore', '$'], function(Backbone, _, $) {
...
define('search/YoutubeSource',['jquery'], function($){
...
define('search/FakeSource',[],function () {
  function FakeSrc() {
...
*/
define('search/Search',['jquery', 'underscore', 'search/YoutubeSource', 'search/FakeSource', 'backbone'], function($, _, YoutubeSource, FakeSrc){
...
define("qrgenerator", (function (global) {
    return function () {
        var ret, fn;
